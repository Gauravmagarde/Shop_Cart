    ...
    <div class="row">
      <div class="col-lg-2" id="hideres">
        <div class="tab" style="border-right: 2px solid #ccc;"><br>
          <p style="margin-left: 8px; font-size: 18px; font-weight: bold; font-family: 'Montserrat', sans-serif;">Books</p>
          <button class="tablinks" onclick="openCity(event, 'All')" id="defaultOpen">All</button>
          <button class="tablinks" onclick="openCity(event, 'Action_Adventure')">Action and Adventure</button>
          <button class="tablinks" onclick="openCity(event, 'Comic')">Comic Book or Graphic Novel</button>
          <button class="tablinks" onclick="openCity(event, 'Fantasy')">Fantasy</button>
          <button class="tablinks" onclick="openCity(event, 'Historical_Fiction')">Historical Fiction</button>
        </div>
      </div>
      <div class="col-lg-10" style="padding-left: 40px;"><br>
        <div id="All" class="tabcontent">
          <div class="product">
            ...
            <div class="row">
              <?php
              include "admin/connect.php";
              $query = mysqli_query($connect, "select * from product where category= 'Books'");
        ...
        <div id="Action_Adventure" class="tabcontent">
          <div class="product">
            <br><br>
            ...
            <div class="row">
              <?php
              include "admin/connect.php";
              $query = mysqli_query($connect, "select * from product where sub_category= 'Action Adventure'");
              $num = mysqli_num_rows($query);
              if ($num > 0) {
                while ($row = mysqli_fetch_array($query)) {
              ?>
        ...
        <div id="Comic" class="tabcontent">
          <div class="product">
            ...
            <div class="row">
              <?php
              include "admin/connect.php";
              $query = mysqli_query($connect, "select * from product where sub_category= 'Comic'");
              $num = mysqli_num_rows($query);
              if ($num > 0) {
                while ($row = mysqli_fetch_array($query)) {
              ?>
        ...
        <div id="Fantasy" class="tabcontent">
          <div class="product">
            ...
            <div class="row">
              <?php
              include "admin/connect.php";
              $query = mysqli_query($connect, "select * from product where sub_category= 'Fantasy'");
              $num = mysqli_num_rows($query);
              if ($num > 0) {
                while ($row = mysqli_fetch_array($query)) {
              ?>
        ...
        <div id="Historical_Fiction" class="tabcontent">
          <div class="product">
            <br><br>
            <h3 style="font-family:new times roman;">Featured Product</h3>
            <br><br><br>
            <div class="row">
              <?php
              include "admin/connect.php";
              $query = mysqli_query($connect, "select * from product where sub_category= 'Historical fiction'");
              $num = mysqli_num_rows($query);
              if ($num > 0) {
                while ($row = mysqli_fetch_array($query)) {
              ?>
