...
<body style="background: #f1f1f1;">
  ...
  <section>
    <div class="conatiner">
      <form method="POST">
        <table class="table1" align="center" cellpadding="8" width="500" style="font-family: sans-serif; font-size: 15px; font-weight: bold; font-style: normal; border-collapse: collapse;  width: 500px; height: 300px; background: white;box-shadow: 0px 8px 16px 0px rgba(0,0,0,.50);">
          <tr>
            <td>
              <h3 style="color:black; font-size: 24px; font-family: sans-serif; padding-left: 10px; border-bottom: 2px solid grey; width: 200px; margin-bottom: 30px;">Category</h3>
            </td>
          </tr><br><br><br>
          <tr>
            <td>Category</td>
            <td><input type="text" class="form-control" type="text" name="category_name" placeholder="Enter category" required></td>
          </tr>
          <tr>
            <td>Description</td>
            <td><textarea class="form-control" rows="4" cols="20" placeholder="write description here.." name="category_desc" required></textarea></td>
          </tr>
          <tr>
            <td>
    ...
    <div id="category" class="">
      ...
      <div class="data-list">
        <div class="container" style="width: 70%;">
          <tr>
            <td>
              <h3 style="color:black; font-size: 24px; font-family: sans-serif; margin-left: 50px; border-bottom: 2px solid grey; width: 210px; margin-top: 20px;">Category Data</h3>
            </td>
          </tr><br>
            ...
            ?>
              <tbody>
                <tr>
                  ...
                  <td><?php echo $datalist['category_name']; ?></td>
                  <td><?php echo $datalist['category_desc']; ?></td>
                  <td><?php echo $datalist['creation_date']; ?></td>
                  <td><?php echo $datalist['update_date']; ?></td>
                  <?php echo "
        <td>
          <div class='btn' style=''>
          <a href='update_c.php?id=" . $datalist['id'] . "' style='color: green; font-size: 21px;'><i class='fa fa-pencil-square-o' aria-hidden='true' style=''></i></a></div></td>
          <td>
          <div class='btn' style=''>
          <a href='delete_category.php?id=" . $datalist['id'] . "' style='color: red; font-size: 21px;'><i class='fa fa-times' aria-hidden='true'></i></a></td>
        </div>"; ?>
                </tr>
              <?php
            }
  ...
  if (isset($_POST['login'])) {
    ...
    $sql = "INSERT INTO category(category_name, category_desc, creation_date) VALUES ('$c','$d','$current_time')";
