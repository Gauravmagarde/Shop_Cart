...
<body style="background: #f1f1f1;">
    ...
    <div class="conatiner">
      <form method="POST">
        <table align="center" cellpadding="8" width="500" style="font-family: sans-serif; font-size: 15px; font-weight: bold; font-style: normal; border-collapse: collapse;  width: 500px; height: 300px; background: white;box-shadow: 0px 8px 16px 0px rgba(0,0,0,.50);">
          <tr>
            <td>
              <h3 style="color:black; font-size: 26px; font-family: sans-serif; padding-left: 10px; border-bottom: 2px solid grey; width: 200px; margin-bottom: 30px;">Sub Category</h3>
            </td>
          </tr><br><br><br>
          <tr>
            <td>Category</td>
          ...
          <tr>
            <td>Sub-Category</td>
            <td><input class="form-control" type="text" name="sub_cat" placeholder="Enter sub-category" required></td>
          </tr>
          <tr>
            <td>
  ...
  <section>
    <div id="sub_category" class="">
      <?php

      $sub_cat = "select * from sub_category";
      $data = mysqli_query($connect, $sub_cat);
      $count = 0;
      ...
      <div class="data-list">
        <div class="container" style="width: 70%;">
          <tr>
            <td>
              <h3 style="color:black; font-size: 24px; font-family: sans-serif; margin-left: 50px; border-bottom: 2px solid grey; width: 250px; margin-top: 20px;">Sub Category Data</h3>
            </td>
          </tr><br>
          <table class="table table-hover table-bordered  table-sm" style=" background: white; margin-left: 50px;">
            ...
            ?>
              <tbody>
                <tr>
                  ...
                  <td><?php echo $datalist['cat_id']; ?></td>
                  <td><?php echo $datalist['sub_cat']; ?></td>
                  <td><?php echo $datalist['creation_date']; ?></td>
                  <td><?php echo $datalist['update_date']; ?></td>
                  <?php echo "
        <td>
          <div class='btn' style=''>
          <a href='update_s.php?id=" . $datalist['id'] . "' style='color: green; font-size: 21px;'><i class='fa fa-pencil-square-o' aria-hidden='true' style=''></i></a></div></td>
          <td>
          <div class='btn' style=''>
          <a href='delete_s.php?id=" . $datalist['id'] . "' style='color: red; font-size: 21px;'><i class='fa fa-times' aria-hidden='true'></i></a></td>
        </div>"; ?>
                </tr>
              <?php
            }
  ...
  if (isset($_POST['login'])) {
    ...
    $sql = "INSERT INTO sub_category(cat_id, sub_cat,creation_date) VALUES ('$c','$s','$current_time')";
