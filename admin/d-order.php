...
<body>
  <div class="container-fluid" style="background: #509900;">
    <nav class="navbar">
      <li class="navbar-brand" style="color: white; margin-left: 180px">Dasboard</li>
    ...
    <div id="Manage-Product" class="product">
      <div class="data-list">
        <div class="container" style="width: 70%;">
          <tr>
            <td>
              <h3 style="color:black; font-size: 26px; font-family: sans-serif; padding-left: 10px; border-bottom: 2px solid grey; width: 200px; margin-top: 20px; position: relative;">Delivered Order</h3>
            </td>
          </tr><br>
