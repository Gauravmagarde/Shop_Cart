...
<body>
  ...
  <section>
    <div id="User_log" class="product">
      <?php

      $user = "select * from user_log";
      ...
      <div class="data-list">
        <div class="container" style="width: 70%;">
          <tr>
            <td>
              <h3 style="color:black; font-size: 26px; font-family: sans-serif; padding-left: 10px; border-bottom: 2px solid grey; width: 200px; margin-top: 20px; position: relative; margin-left: 50px;">User Log</h3>
            </td>
          </tr><br>
            ...
            ?>
              <tbody>
                <tr>
                  ...
                  <td><?php echo $datalist['user_email']; ?></td>
                  <td></td>
                  <td><?php echo $datalist['login_date_time']; ?></td>
                  <td><?php echo $datalist['logout_date_time']; ?></td>
                  <td></td>
                </tr>
              <?php
            }
