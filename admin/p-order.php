...
<body>
  ...
  <section>
    <div id="Order_details" class="product">
      <?php
      ...
      <div class="data-list">
        <div class="container" style="width: 70%;">
          <tr>
            <td>
              <h3 style="color:black; font-size: 24px; font-family: sans-serif; padding-left: 10px; border-bottom: 2px solid grey; width: 120px; margin-top: 20px; margin-left: 50px;">Order</h3>
            </td>
          </tr><br>
              ...
              ?>
                <tbody>
                  <tr>
                    ...
                    <td><?php echo $row['shipping_pincode']; ?></td>
