    ...
    <div class="row">
      <div class="col-lg-2" id="hideres">
        <div class="tab" style="border-right: 2px solid #ccc;"><br>
          <p style="margin-left: 8px; font-size: 18px; font-weight: bold; font-family: 'Montserrat', sans-serif;">Furniture</p>
          <button class="tablinks" onclick="openCity(event, 'All')" id="defaultOpen">All</button>
          <button class="tablinks" onclick="openCity(event, 'Sofa_Sets')">sofa Sets</button>
          <button class="tablinks" onclick="openCity(event, 'Bed')">Bed</button>
          <button class="tablinks" onclick="openCity(event, 'cabinates')">Cabinates</button>
          <button class="tablinks" onclick="openCity(event, 'Dining')">Dining Table</button>
        </div>
      </div>
      <div class="col-lg-10" style="padding-left: 40px;"><br>
        <div id="All" class="tabcontent">
          <div class="product">
            ...
            <div class="row">
              <?php
              include "admin/connect.php";
              $query = mysqli_query($connect, "select * from product where category= 'Furniture'");
        ...
        <div id="Sofa_Sets" class="tabcontent">
          <div class="product">
            <br><br>
            ...
            <div class="row">
              <?php
              include "admin/connect.php";
              $query = mysqli_query($connect, "select * from product where sub_category= 'Sofa sets'");
              $num = mysqli_num_rows($query);
              if ($num > 0) {
                while ($row = mysqli_fetch_array($query)) {
              ?>
        ...
        <div id="Bed" class="tabcontent">
          <div class="product">
            ...
            <div class="row">
              <?php
              include "admin/connect.php";
              $query = mysqli_query($connect, "select * from product where sub_category= 'Bed'");
              $num = mysqli_num_rows($query);
              if ($num > 0) {
                while ($row = mysqli_fetch_array($query)) {
              ?>
        ...
        <div id="cabinates" class="tabcontent">
          <div class="product">
            <br> <br>
            <h3 style="font-family:new times roman;">Featured Product</h3>
            <br><br><br>
            <div class="row">
              <?php
              include "admin/connect.php";
              $query = mysqli_query($connect, "select * from product where sub_category= 'cabinets'");
              $num = mysqli_num_rows($query);
              if ($num > 0) {
                while ($row = mysqli_fetch_array($query)) {
              ?>
        ...
        <div id="Dining" class="tabcontent">
          <div class="product">
            ...
            <div class="row">
              <?php
              include "admin/connect.php";
              $query = mysqli_query($connect, "select * from product where sub_category= 'Dining Table'");
              $num = mysqli_num_rows($query);
              if ($num > 0) {
                while ($row = mysqli_fetch_array($query)) {
              ?>
